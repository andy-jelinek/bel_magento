 ...
 */
class MT_RevSlider_Block_Adminhtml_Slider_Edit_Tab_Navigation
    ...
    public function _prepareForm(){
        ...
        $nav11 = $fieldset->addField('navigation_align_hor', 'select', array(
            ...
            'value'     => $model->getData('navigation_align_hor') ? $model->getData('navigation_align_hor') : 'center',
            'note'      => Mage::helper('revslider')->__('Horizontal Align of Bullets / Thumbnails')
        ));
        $nav12 = $fieldset->addField('navigation_align_vert', 'select', array(
            ...
            'value'     => $model->getData('navigation_align_vert') ? $model->getData('navigation_align_vert') : 'bottom',
            'note'      => Mage::helper('revslider')->__('Vertical Align of Bullets / Thumbnails')
        ));
        $nav13 = $fieldset->addField('navigation_offset_hor', 'text', array(
            ...
            'value'     => $model->getData('navigation_offset_hor') ? $model->getData('navigation_offset_hor') : 0,
        ...
        $nav14 = $fieldset->addField('navigation_offset_vert', 'text', array(
            ...
            'value'     => $model->getData('navigation_offset_vert') ? $model->getData('navigation_offset_vert') : 20,
