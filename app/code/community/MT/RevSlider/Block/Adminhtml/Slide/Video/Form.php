 ...
 */
class MT_RevSlider_Block_Adminhtml_Slide_Video_Form extends Mage_Adminhtml_Block_Widget_Form{
    protected function _prepareForm(){
        ...
        $v1 = $fieldset->addField('video_src', 'text', array(
            ...
            'required'  => true,
            'note'      => $this->helper('revslider')->__('Ex: 1TKtHVewzDI or 71754854')
        ));
        ...
        $fieldset->addField('video_autoplayonlyfirsttime', 'checkbox', array(
