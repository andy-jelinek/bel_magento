...
class MT_RevSlider_Model_Slide extends Mage_Core_Model_Abstract{
    ...
    const LAYER_ANI_CUS1        = 'customin-1';
    ...
    const LAYER_ANI_CUSO1       = 'customout-1';
    ...
    public function getLayerAnimationOptions(){
        $options = new Varien_Object(array(
            ...
            self::LAYER_ANI_CUS1    => Mage::helper('revslider')->__('Short from Top')
        ));
        return $options->getData();
    }
    ...
    public function getLayerEndAnimationOptions(){
        $options = new Varien_Object(array(
            ...
            self::LAYER_ANI_CUSO1   => Mage::helper('revslider')->__('Short from Top')
        ));
        return $options->getData();
    }
