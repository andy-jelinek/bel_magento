...
?>
<?php
class MagenThemes_MTBrave_Adminhtml_RestoreController extends Mage_Adminhtml_Controller_Action
{
    ...
    protected function _isAllowed()
    {
        return Mage::getSingleton('admin/session')
            ->isAllowed('magenthemes/mtbrave/restore');
    }

    protected function _initAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('magenthemes/mtbrave/restore')
    ...
    public function indexAction()
    {
        ...
        $this->_title($this->__('MagenThemes'))
            ->_title($this->__('MTBrave'))
            ->_title($this->__('Restore Defaults'));
        $this->_addContent($this->getLayout()->createBlock('mtbrave/adminhtml_restore_edit'));
        $this->renderLayout();
    }
    ...
    public function restoreAction()
    {
	    ...
	    try {
            ...
            $defaults->loadFile(Mage::getBaseDir().'/app/code/local/MagenThemes/MTBrave/etc/config.xml');
            $this->_restoreSettings($defaults->getNode('default/mtbrave_design')->children(), 'mtbrave_design');
            Mage::getSingleton('adminhtml/session')->addSuccess(
                Mage::helper('adminhtml')->__('Default Settings for MTBrave Design Theme has been restored.'));
        }
        catch (Exception $e) {
